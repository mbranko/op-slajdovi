...
\begin{verbatim}
def babezabe():
    babe, zabe = eval(input('Unesite broj baba i broj zaba: ')
    print('Narucili ste', babe, 'baba i', zabe, 'zaba.')

>>> babezabe()
Unesite broj baba i zaba: 3, 2
...
\frame{
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item ispiši uvodnu poruku \\
        \texttt{print('Vrednost 10-godisnjeg ulaganja.')}
      \item unesi početno stanje računa \\
        \texttt{principal = eval(input('Unesite pocetni ulog: '))}
      \item unesi godišnju kamatu \\
        \texttt{principal = eval(input('Unesite kamatu: '))}
...
print("Vrednost 10-godisnjeg ulaganja.")
