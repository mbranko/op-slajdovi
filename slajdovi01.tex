...
# chaos.py
# Ovaj program simulira haoticno ponasanje

print "Ovaj program simulira haoticno ponasanje"
x = eval(raw_input("Unesite broj izmedju 0 i 1: "))
for i in range(10):
    x = 3.9 * x * (1 - x)
    print x
\end{minted}
...
\begin{minted}[linenos=false]{python}
# chaos.py
# Ovaj program ilustruje haoticno ponasanje.
\end{minted}
\begin{itemize}
