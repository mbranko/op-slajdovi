...
\frame{
  ...
  \begin{itemize}
    \item 2 časa predavanja -- svi zajedno
    \item 4 časa vežbi -- po grupama
  \end{itemize}
}
...
\frame{
  ...
  \begin{itemize}
    \item nastavni materijal:
      \url{https://enastava.ftninformatika.com} \\ \ \\
...
\frame{
  ...
  \begin{itemize}
    \item u toku semestra -- domaći zadaci i kolokvijum
